...
def test_simple_positive():
    assert create_transactions('Baz', 'Baz', [RawKarma(name='Foobar', op='++', reason=None)]) == [
...
def test_self_karma_single():
    assert create_transactions('Baz', 'Baz', [RawKarma(name='Baz', op='++', reason=None)]) == [
...
def test_karma_double_positive():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Baz', op='++', reason=None),
                                              RawKarma(name='Baz', op='++', reason=None)]) == [
...
def test_simple_positive_reason():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Baz', op='++', reason='Foobar is baz')]) == [
...
def test_simple_neutral_reason():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Baz', op='+-', reason='Foobar is baz')]) == [
        KarmaTransaction(name='Baz', self_karma=False, net_karma=0, reasons=['Foobar is baz'])]


def test_self_karma_single_reason():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Bar', op='++', reason='Is awesome')]) == [
...
def test_self_karma_multiple_reason():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Bar', op='++', reason='Is awesome'),
               ...
               KarmaTransaction(name='Bar', self_karma=True, net_karma=1, reasons=['Is awesome', 'Is awesome'])
           ]
...
def test_karma_double_positive_reasons():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Baz', op='++', reason='Foobar baz 1'),
                                              RawKarma(name='Baz', op='++', reason='Foobar baz 2')]) == [
               KarmaTransaction(name='Baz', self_karma=False, net_karma=1, reasons=['Foobar baz 1', 'Foobar baz 2'])]
...
def test_karma_double_neutral_reasons():
    assert create_transactions('Bar', 'Bar', [RawKarma(name='Baz', op='+-', reason='Foobar baz 1'),
                                              RawKarma(name='Baz', op='-+', reason='Foobar baz 2')]) == [
               KarmaTransaction(name='Baz', self_karma=False, net_karma=0, reasons=['Foobar baz 1', 'Foobar baz 2'])]
