...
class Vote(Base):
    ...
    choices = relationship("VoteChoice", back_populates="vote", cascade="all, delete-orphan")
    discord_vote = relationship("DiscordVote", back_populates="vote", cascade="all, delete-orphan")
...
class VoteChoice(Base):
    ...
    user_votes = relationship("UserVote", back_populates="vote_choice", cascade="all, delete-orphan")
...
class DiscordVote(Base):
    ...
    messages = relationship(DiscordVoteMessage, back_populates="discord_vote", cascade="all, delete-orphan")
