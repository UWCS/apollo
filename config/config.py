...
class Config:
    def __init__(self, filepath):
        ...
        self.UWCS_AUTOMOD_LOG_CHANNEL_ID: int = parsed.get(
            "UWCS_automod_log_channel_id"
        )
        self.UWCS_JOIN_LEAVE_LOG_CHANNEL_ID: int = parsed.get(
            "UWCS_join_leave_log_channel_id"
        )
        self.UWCS_MEMBER_LOG_CHANNEL_ID: int = parsed.get("UWCS_member_log_channel_id")
        self.UWCS_MESSAGE_LOG_CHANNEL_ID: int = parsed.get(
            "UWCS_message_log_channel_id"
        )
